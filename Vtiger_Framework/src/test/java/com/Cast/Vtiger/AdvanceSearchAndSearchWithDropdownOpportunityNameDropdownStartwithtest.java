...
public class AdvanceSearchAndSearchWithDropdownOpportunityNameDropdownStartwithtest extends BaseClass {
	...
	public void createOpportunityWithContact3() throws IOException, Throwable {
		...
		System.out.println(text1 +"="+ " the opportunity name starts with "+ opportunity);		
