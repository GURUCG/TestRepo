...
public class AdvanceSearchAndSearchWithDropdownOpportunityNameDropdowncontainstest extends BaseClass{
	...
	public void createOpportunityWithContact5() throws IOException, Throwable {
		...
		System.out.println(text1 +"="+ " the opportunity name contains"+ opportunity);
