...
public class AdvanceSearchAndSearchWithDropdownOpportunityNameDropdownEndwithtest extends BaseClass {
	...
	//	Assert.fail();
		...
		System.out.println(text1 +"="+ " the opportunity name ends with "+ opportunity);
